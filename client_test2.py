...
class LLMInterface:
    ...
    def engage(context: InteractionContext, timeout: int=30) -> ChatCompletionMessage | str:
        ...
        client: OpenAI = LLMInterface.getClient(str(context.provider))
        if client is None:
            return "ERROR: Client '{}' does not exist.".format(context.provider)
...
if __name__ == "__main__":
    ...
    cont = InteractionContext("mockgpt", "mock-gpt")
